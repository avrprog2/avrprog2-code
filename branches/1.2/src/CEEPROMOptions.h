...
#ifndef CEEPROMOPTIONS_H_
#define CEEPROMOPTIONS_H_

#include "CMemoryOptions.h"

/**
 * @brief Parses command line arguments for eeprom memory operations.
 *
 * See CMemoryOptions for more details.
 *
 * @throw 	ProgramOptionsException on error.
 */
class CEEPROMOptions : public CMemoryOptions {
public:
	/**
	 * @param	options	Command line argument.
	 */
	CEEPROMOptions(string options);
	virtual ~CEEPROMOptions();
};

#endif /* CEEPROMOPTIONS_H_ */
